...
//Level 3 PointerLock Control 
/*const controls3 = new THREE.PointerLockControls(camera3, renderer.domElement);

controls3.addEventListener('lock',function(){
  menu.style.display = 'none'
});

controls3.addEventListener('unlock',function(){
